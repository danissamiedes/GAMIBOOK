        ...
        <>
          <Card className="mb-4">
            ...
            <p className="mt-1 text-2xl font-semibold tabular-nums">
              {agreed.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </p>
            <p className="mt-1 text-xs text-slate-500">
              Deliberately absent from the P&amp;L — this is agreed work, not revenue.
            </p>
          </Card>
          ...
          <Card>
            <table className="w-full text-sm">
              ...
              <tbody>
                {orders.map((order) => (
                  <tr key={order.id} className="border-b border-slate-100 dark:border-slate-800/60">
                    ...
                    <td className="py-2">{formatAccountingDate(order.orderDate)}</td>
                    <td className="py-2">
                      <span
